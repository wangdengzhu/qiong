<template>
  <div class="wrap">
    <div class="file-con">
      <div>
        <img v-if="!imgUrl.length" src="../assets/images/plus.png">
    ...
    <div class="tips">温馨提示：建议放入您本人真实头像</div>
    <div>
...
export default {
  ...
  methods: {
    upload (event) {
      ...
      self.imgUrl = URL.createObjectURL(file)
